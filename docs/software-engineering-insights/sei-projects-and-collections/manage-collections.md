...
Inheritance flows down the Collection levels. For example, Collection categories and Collections inherit [SEI integrations](../../category/sei-integrations/) from the associated [Harness project](../../category/organizations-and-projects/), and child Collections inherit [Insights associations](manage-collections.md#manage-insights-associations) from their ancestor Collections. For more information about the relationship between projects, Collection categories, and Collections, go to [Collection hierarchies](manage-collection-cat/).
...
5. Use the **Insights** settings to [manage Insights associations](manage-collections.md#manage-insights-associations). By default, child Collections automatically inherit Insights associations from their ancestor Collections.

![](static/collection-step3.png)

6. Use the **Definition** settings to define [integrations](../../category/integrations/) associated with the Collection. By default, if you don't specify any integrations, the Collection automatically inherits integrations from the associated project.
7. Follow the steps to define an Asset Based Collection. To learn more, go to [Asset Based Collections](manage-collections.md#asset-based-collections)
   * In the **Collection Definition** settings, add the relevant [Integration](../sei-integrations/sei-integrations-overview/) to define the digital asset.\
...
8. Follow the steps to define an People Based Collection. To learn more, go to [People Based Collections](manage-collections.md#people-based-collections).
...
All [Insights](../insights/sei-insights/) must be associated with at least one Collection. You can configure these associations through Collection settings or when creating or editing Insights. For information about creating and editing Insights, go to [Insights](../insights/sei-insights/).
...
1. Follow the steps to [add and edit Collections](manage-collections.md#add-and-edit-collections), and go to the Collection's **Insights** settings.
