...
3. Select the associated **Pagerduty integration**. To learn about how to configure the integration, go to [PagerDuty integration](../../sei-integrations/other-integrations/sei-integration-pagerduty/).
