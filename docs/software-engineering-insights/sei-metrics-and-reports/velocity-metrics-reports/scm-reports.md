...
Reports can be filtered by project, repository, time range, and other data points, depending on your SCM [integrations](../../sei-integrations/sei-integrations-overview/).
...
Some code velocity metrics contribute to [Trellis Scores](../trellis-score/):
...
With the **SCM Committers Report**, you can analyze the following data for each committer in the [Collection](../../sei-projects-and-collections/manage-collections/):
...
For more information about CI/CD job reports, go to [CI/CD job reports](ci-cd-reports/).
...
Only GitHub is supported, and your [GitHub SEI integration](../../sei-integrations/automated-integrations/sei-integration-github/) must have the appropriate configuration to ingest issue cycle time data.

### SCM PR reports

Use the SCM PR reports to analyze data related to Pull Requests (also known as Merge Requests).

* [**SCM PRs Report**](scm-reports.md#scm-prs-report)**:** A high-level view of PRs moving through your SCM tool.
...
* [**SCM PR Lead Time by Stage Report**](scm-reports.md#scm-pr-lead-time-by-stage-report)**:** Examine lead time based on your defined PR lifecycle stages. By default, this report shows the average time for all PRs. You can drill down to explore data for individual PRs.
...
To examine PRs by committer, use the [SCM Committers Report](scm-reports.md#scm-committers-report).

To understand how lead time is calculated, go to [PR lead time calculation](scm-reports.md#pr-lead-time-calculation).
...
\<img src={require('./static/scm-review-collaboration.png').default} alt="Example banner" height="50%" width="100%" border="1" />
...
\<img src={require('./static/scm-pr-report.png').default} alt="Example banner" height="50%" width="50%" border="1" />
...
\<img src={require('./static/scm-coding-days.png').default} alt="Example banner" height="50%" width="100%" border="1" />
...
4. Configure the filters for the widget, such as source/destination branch, reviewer, label, and so on. This defines the types of commits or PRs that are considered in the [lead time calculation](scm-reports.md#pr-lead-time-calculation).
5. On the **Settings** tab, select the relevant [Workflow profile](scm-reports.md#workflow-profiles-for-lead-time), and then select **Next: Place Widget**.
