...
sidebar_position: 8
description: >-
  Backup your Harness CD configurations to Git using the Harness Git Experience
  and Harness Terraform Provider.
---

# Backup Harness in Git using Git Experience and Terraform
...
* [Harness Git Experience overview](../../../platform/git-experience/git-experience-overview/)&#x20;
* [Onboard with Terraform Provider](../../../platform/get-started/tutorials/onboard-terraform-provider/)
...
1.  Install the Harness Terraform Provider: Add the Harness provider to your Terraform configuration. For more information, go to the [Terraform Provider docs](https://registry.terraform.io/providers/harness/harness/latest/docs/resources/platform\_pipeline).
