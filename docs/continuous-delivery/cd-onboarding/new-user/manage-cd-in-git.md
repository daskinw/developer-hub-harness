...
# Managing Harness CD resources in Git
...
* [Harness Git Experience quickstart](../../../platform/git-experience/configure-git-experience-for-harness-entities/)
* [Import a pipeline from Git](../../../platform/git-experience/import-a-pipeline/)
