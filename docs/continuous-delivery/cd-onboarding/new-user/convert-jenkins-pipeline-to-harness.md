...
# Convert a Jenkins pipeline to a Harness CD pipeline
...
For more information on delegate, go to [Delegate Overview](../../../platform/delegates/delegate-concepts/delegate-overview/).&#x20;
...
4. The _**Deploy to Dev**_, _**Deploy to QA**_, and _**Deploy to Prod**_ stages deploy the NGINX setup to the respective Kubernetes clusters using **kubectl apply**.&#x20;
...
Services represent your microservices and other workloads. For more information, go to [Create Services](../../x-platform-cd-features/services/create-services/).
...
Environments represent your deployment targets (QA, Prod, etc). For more information, go to [Create Environments](../../x-platform-cd-features/environments/create-environments/).

#### What is an Infrastructure Definition?

Infrastructure definitions represent an environment's infrastructures physically. They are the actual clusters, hosts, namespaces, etc., where you are deploying a service. For more information, go to [Add Infrastructure Definitions](../../x-platform-cd-features/environments/create-environments/#add-infrastructure-definitions).
...
*   **Using Templates:** Templates can help you reduce the number of stages, steps, or pipelines you need to define. You can reference templates to reuse and share similar configuration across various pipelines. For more information, go to [Templates](../../../platform/templates/template/).

    ![picture 0](static/fbc468630528873e3780cc868dcd535f5260425da43ce69852754e8e85b1a81d.png)
*   **On Artifact Triggers:** Triggers help automate application deployments. With triggers, you can decouple your build process from your deployment process. Once the code is built and a specific tag is published, the artifact can be polled and used to trigger CD pipeline deployments. For more information, go to [Trigger on a new Artifact](../../../platform/triggers/trigger-on-a-new-artifact/).
...
1. Orientation session
   * [Harness CD Key Concepts](../../get-started/key-concepts/)&#x20;
   * [CD Pipeline Modeling Overview](../../get-started/cd-pipeline-modeling-overview/)
2. Technical Training
   * [Tutorials](../../../category/cd-and-gitops-tutorials/). Harness offers a wide variety of tutorials to help users get started.
