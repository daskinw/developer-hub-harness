...
sidebar_position: 1
description: >-
  This topic describes how to enable Harness user group(s) to approve or reject
  a stage at any point in its execution.
---
...
* [Harness Approval stages](../../../../platform/approvals/adding-harness-approval-stages/): Add Approval stages for manual intervention.
* [Adding Jira Approval stages and steps](../../../../platform/approvals/adding-jira-approval-stages/): Add Jira Approval stages and steps.
* [Adding ServiceNow Approval steps and stages](../../../../platform/approvals/service-now-approvals/): Add ServiceNow Approval stages and steps.
...
1. In **User Groups**, select the Harness user groups that will approve the step. For more information, go to [Manage user groups](../../../../platform/role-based-access-control/add-user-groups/).
