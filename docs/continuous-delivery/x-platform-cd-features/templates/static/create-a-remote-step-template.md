...
![](static/create-a-remote-step-template-16.png) This topic walks you through the steps to create a Remote Step Template.
...
4. In **Execution Target**,​ specify where you want to execute the script.\
   ...
   For more information, see [Using Shell Scripts in CD Stages](../../cd-steps/utilities/shell-script-step.md).
