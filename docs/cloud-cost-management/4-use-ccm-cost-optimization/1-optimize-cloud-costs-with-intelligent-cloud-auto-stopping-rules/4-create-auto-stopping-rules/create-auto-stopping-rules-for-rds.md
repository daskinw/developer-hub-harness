...
description: >-
  This topic describes how to create AutoStopping Rules for Amazon Relational
...
See [Use Harness AutoStopping CLI to Keep the RDS Instance(s) Running](create-auto-stopping-rules-for-rds.md#use-harness-autostopping-cli-to-keep-the-rds-instances-running).
...
2.  In **Select RDS Instance**, do the following:
    ...
    ![](static/create-auto-stopping-rules-for-rds-78.png) 3. Once you've made all the selections, click **Add Selected**.
3. Click **Next**.
...
* **Add Dependency**: Set dependencies between two or more AutoStopping Rules when you want one Rule to make one or more Rules to be active based on the traffic that it receives. See [Add Dependency](create-autostopping-rules-aws.md#optional-step-set-up-advanced-configuration).
