...
import harness\_atl from './static/atlanta\_light.png'
...
Can see what the tab value ='s then the anchor tab there in combination and for nested tabs can continue. `?pipeline=cd-pipeline&cli-os=windows#getting-started-with-harness-cd`
...
![Harness Atlanta Background](static/atlanta\_light.png)
...
![Harness Atlanta](%7Bharness\_atl%7D)
...
\<DocImage path={require('./static/atlanta\_light.png')} />
