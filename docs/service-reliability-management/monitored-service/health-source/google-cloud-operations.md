...
# Configure Google Cloud Operations as health source
...
4.  In **Select health source type**, select Google Cloud Operations.
...
7. In **Connector** settings, you can either choose an existing connector Gcp connector or click **New Connector.** ![](static/verify-deployments-with-google-cloud-operations-125.png)
8. Click **Apply Selected**. The Connector is added to the Health Source.
9. In **Select Feature**, select the feature to be used.
