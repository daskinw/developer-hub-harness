...
You can choose to disable the Harness built-in Secret Manager at any point and use any other [Secret Manager](../../get-started/tutorials/add-secrets-manager.md) to store secrets.

This topic explains how to disable the built-in Harness Secret Manager.

#### Before you begin

* [Harness Secret Management Overview](harness-secret-manager-overview/)
...
* Make sure you have Account Admin permissions to disable the built-in Secret Manager.\
  For more information, go to [Permissions Reference](../../role-based-access-control/permissions-reference/).
...
* [Add an AWS KMS Secret Manager](add-an-aws-kms-secrets-manager/)
