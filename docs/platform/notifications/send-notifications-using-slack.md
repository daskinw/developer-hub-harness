...
You can notify your User Group members using Slack as one of the notification channels. To do this, add a Slack Incoming Webhook into your Harness User Groups' [Notification Preferences](../role-based-access-control/add-user-groups/#edit-notification-preferences).

Then you can add your User Group to a Notification Strategy and receive alert info in Slack.

#### Before you begin

* See [User Group Notification Preferences](../role-based-access-control/add-user-groups/#edit-notification-preferences)
...
![](static/send-notifications-using-slack-17.png) Copy the Webhook.
...
5. Paste the Webhook into **Slack Webhook URL**  or add it as an [Encrypted Text](../secrets/add-use-text-secrets/) in Harness and reference it here.\
