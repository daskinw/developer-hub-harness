...
You can create the policy and apply it to all Secrets in your Account, Org, and Project. The policy is evaluated on Secret-level events like **On Save,** which occurs during Secret Creation and Updates. See [Harness Governance Quickstart](harness-governance-quickstart/).​
...
Select **Policies**, and then select **New Policy**. **New Policy** settings appear.
...
![](static/add-a-policy-engine-step-to-a-secret-49.png) Existing Secrets are not automatically updated with policies. Policies can be applied to Secrets only on a save when they are created or updated.In **Policy evaluation criteria**, click **Add Policy.**
...
* [​Harness Policy As Code Overview​](../../../feature-flags/harness-policy-engine.md)
