...
description: >-
  Lists the available features and the roadmap for the Self-Managed Enterprise
  Edition of Harness Feature Flags.
---

# Self Managed Platform roadmap and feature availability
...
The Following SDKs **do **_**not**_** currently support** Self-Managed Enterprise Edition:
