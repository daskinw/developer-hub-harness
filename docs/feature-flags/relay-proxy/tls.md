...
*   **External TLS (recommended)**
    ...
    ![TLS Setup](images/TLS.png)

    A sample docker compose for this architecture is included in this [examples folder](https://github.com/harness/ff-proxy/tree/main/examples/tls\_reverse\_proxy) in GitHub.
*   **Native TLS**

    You can configure the Relay Proxy to start with HTTPS enabled. This can be configured using the [TLS configuration options](configuration/#tls).
    ...
    ![TLS Setup](images/native\_tls.png)
