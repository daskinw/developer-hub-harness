...
description: >-
  This topic explains how to use the Feature Flags (FF) SDK in your Flutter
  application.
---
...
* (For Android apps) Install [Android Studio](https://developer.android.com/studio?gclid=CjwKCAjwp7eUBhBeEiwAZbHwkRqdhQkk6wroJeWGu0uGWjW9Ue3hFXc4SuB6lwYU4LOZiZ-MQ4p57BoCvF0QAvD\_BwE\&gclsrc=aw.ds), or install the Android SDK for Command-Line Interface (CLI) only.
...
:::info note To check if you have installed the prerequisites, run the `flutter doctor` command. :::
