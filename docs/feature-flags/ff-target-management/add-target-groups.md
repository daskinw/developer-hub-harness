...
import target\_group\_1 from './static/2-add-target-groups-06.png' import target\_group\_2 from './static/2-add-target-groups-07.png' import target\_group\_3 from './static/2-add-target-groups-08.png' import target\_group\_4 from './static/2-add-target-groups-09.png' import target\_group\_5 from './static/2-add-target-groups-10.png'

:::info note While targets are often users, a target can be anything that can be uniquely identified. For example, a target can be a user, an application, a system, a machine, or any resource uniquely identified by an IP address, email ID, user ID, etc. :::
...
![The edit button next to Criteria.](%7Btarget\_group\_1%7D)

1. From here, you can [**include or exclude specific targets**](add-target-groups.md#add-or-exclude-specific-targets), or you can set rules to [**add targets based on conditions**](add-target-groups.md#add-targets-based-on-conditions) you set.
...
*   To exclude targets, in **Exclude the following**, select the targets.
    ...
    ![A screenshot of targets added to the Target Group Criteria.](%7Btarget\_group\_2%7D)

#### Add targets based on conditions

:::info note When you create a target based on Conditions, on the target overview page the group isn't displayed under the **Target Groups** column. :::
...
![An example of the target group Criteria page with a condition added.](%7Btarget\_group\_3%7D)

5. Click **Save**. Targets that meet the criteria are now included in the target group.

![The Target Groups page with the new condition displayed.](%7Btarget\_group\_4%7D)
...
2.  Click **Target Groups**, and then select either or both of the following:
    ...
    *   **Exclude from Target Groups** to exclude a specific target
        ...
        ![A screenshot of a target with the Target Groups tab opened.](%7Btarget\_group\_5%7D)
