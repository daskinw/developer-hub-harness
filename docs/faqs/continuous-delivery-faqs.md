...
For an overview of Harness' support for platforms, methodologies, and related technologies, see [Supported platforms and technologies](../platform/platform-whats-supported.md).

**What CD platforms and tools does Harness support?**

Harness [supports all of the most common platforms](../continuous-delivery/cd-integrations.md) and deployment use cases.
...
See [Define your Kubernetes target infrastructure](../continuous-delivery/deploy-srv-diff-platforms/kubernetes/define-your-kubernetes-target-infrastructure.md).
...
For detailed instructions on using Kubernetes in Harness, see the [Kubernetes how-tos](../category/kubernetes/).
...
In addition to this method, you can also deploy the Helm chart without adding your artifact to Harness. Instead, the Helm chart identifies the artifact. Harness installs the chart, gets the artifact from the repo, and then installs the artifact. We call this a _Helm chart deployment_.
...
:::note Harness supports CRDs for both Kubernetes and OpenShift. There is no difference in their custom resource implementation. :::
...
Typically, If the Docker artifact source is in a private registry, Harness has access to that registry using the credentials set up in the Harness [Artifact connector](../platform/connectors/artifact-repositories/connect-to-an-artifact-repo/).
...
* **Kustomization Configuration** — kustomization.yaml files stored on a remote Git repo. See [Kustomize deployment tutorial](../continuous-delivery/deploy-srv-diff-platforms/kustomize/kustomize-quickstart.md).
* **OpenShift Template** — OpenShift params file from a Git repo.

:::note Remote files can also use Go templating. :::
...
* [Terraform](../continuous-delivery/cd-infrastructure/terraform-infra/terraform-provisioning-with-harness/)
* [Terragrunt](../continuous-delivery/cd-infrastructure/terragrunt-howtos/)
* Azure ARM and Blueprint
* [AWS CloudFormation](../continuous-delivery/cd-infrastructure/cloudformation-infra/cloud-formation-how-tos/)
* Shell script (custom)
...
See [Kustomize deployment tutorial](../continuous-delivery/deploy-srv-diff-platforms/kustomize/kustomize-quickstart.md).
...
* The [Harness CD & GitOps SaaS Free Plan](https://app.harness.io/auth/#/signup/?module=cd\&utm\_source=website\&utm\_medium=harness-developer-hub\&utm\_campaign=cd-plg) is the recommended option for new users since there is no server side installation to manage.
...
* [Azure ARM](../continuous-delivery/cd-infrastructure/azure-arm-provisioning/)
* [Azure Blueprint](../continuous-delivery/cd-infrastructure/azure-blueprint-provisioning/)
* [Terraform](../continuous-delivery/cd-infrastructure/terraform-infra/terraform-provisioning-with-harness/)
...
We do support [deployment templates](../continuous-delivery/deploy-srv-diff-platforms/custom-deployment-tutorial/) to achieve the use case.
...
* [Container step](../continuous-delivery/x-platform-cd-features/cd-steps/utilities/container-step/)
* [Container step group](../continuous-delivery/x-platform-cd-features/cd-steps/containerized-steps/containerized-step-groups/)
* [Shell Script step](../continuous-delivery/x-platform-cd-features/cd-steps/utilities/shell-script-step/)
* [Shell Script Provisioner](../continuous-delivery/cd-infrastructure/shell-script-provisioning/)
...
For more information, go to [Deploy Azure ACR to Azure AKS](../continuous-delivery/deploy-srv-diff-platforms/azure/azure-cd-quickstart/).
...
For more information, go to [Add an Azure Key Vault secret manager](../platform/secrets/secrets-management/azure-key-vault/).
...
* [VM deployments using SSH](../continuous-delivery/deploy-srv-diff-platforms/traditional/ssh-ng/)
* [Windows VM deployments using WinRM](../continuous-delivery/deploy-srv-diff-platforms/traditional/win-rm-tutorial/)
...
For more information, go to [Azure Web Apps deployments](../continuous-delivery/deploy-srv-diff-platforms/azure/azure-web-apps-tutorial/).
...
* [RegisterTaskDefinition](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API\_RegisterTaskDefinition.html)
* [CreateService](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API\_CreateService.html)
* [RegisterScalableTarget](https://docs.aws.amazon.com/autoscaling/application/APIReference/API\_RegisterScalableTarget.html)
* [PutScalingPolicy](https://docs.aws.amazon.com/autoscaling/application/APIReference/API\_PutScalingPolicy.html)
* [RunTask](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API\_RunTask.html)
...
**Looking for Serverless.com Framework Lambda?** Harness also supports Serverless.com Framework Lambda deployments. For more information, go to [AWS Lambda deployments (Serverless.com Framework)](../continuous-delivery/deploy-srv-diff-platforms/serverless/serverless-lambda-cd-quickstart/).
...
Harness uses the AWS Lambda [Create Function API](https://docs.aws.amazon.com/lambda/latest/dg/API\_CreateFunction.html) to create a new Lambda function in the specified AWS account and region.
...
For a full list of supported fields, go to [AWS Lambda Create Function Request](https://docs.aws.amazon.com/lambda/latest/dg/API\_CreateFunction.html).
...
For an overview of Harness entities, see [Learn Harness' key concepts](../platform/get-started/key-concepts.md).
...
See [Connect to an artifact repo](../platform/connectors/artifact-repositories/connect-to-an-artifact-repo/).
...
See Harness [Connectors how-tos](../category/connectors/).
...
See [Harness secrets management overview](../platform/secrets/secrets-management/harness-secret-manager-overview/).
...
See [Fixed values, runtime inputs, and expressions](../platform/variables-and-expressions/runtime-inputs/).
...
See [Iteration Counts](../platform/pipelines/looping-strategies/looping-strategies-matrix-repeat-and-parallelism/#iteration-counts)
