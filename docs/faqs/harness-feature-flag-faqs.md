...
description: >-
  This article addresses some frequently asked questions about Harness Feature
  Flags (FF).
---
...
For more information, see [Add targets](../feature-flags/ff-target-management/add-targets/) and [Manage target groups](../feature-flags/ff-target-management/add-target-groups/).
...
For more information, see [Java SDK reference](../feature-flags/ff-sdks/server-sdks/integrate-feature-flag-with-java-sdk.md) and [Add targets](../feature-flags/ff-target-management/add-targets/).
