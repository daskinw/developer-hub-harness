...
description: >-
  Describes how to use Explorer to view, understand, and analyze your cloud
  cost.
---
...
:::note If you select an unsupported combination, **invalid combination of group by and filters** error is thrown. :::
...
:::note For ECS clusters, you can replace nodes with container instances and pods with tasks.#### Node Cost :::
