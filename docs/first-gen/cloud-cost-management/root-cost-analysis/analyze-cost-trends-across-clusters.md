...
description: >-
  Describes how to view your cluster costs at a glance, understand, and analyze
  cost trends.
---
...
:::note The ECS clusters that you want to monitor must have a Harness Delegate associated with it. But, with [AWS accounts](../setup-cost-visibility/enable-continuous-efficiency-for-aws.md) you can get the comprehensive view of the ECS clusters without having Harness Delegate associated. :::

### Blog Post

The following blog post walks you through optimizing Kubernetes cluster costs:

[Optimizing Kubernetes Cluster Costs](../ccm-recommendations/recommendations.md)
...
* AWS and GCP costs are not trued-up for cluster resources. To view the applicable discounts:
  * Setup your [AWS](../setup-cost-visibility/enable-continuous-efficiency-for-aws.md) and [GCP](../setup-cost-visibility/enable-cloud-efficiency-for-google-cloud-platform-gcp.md) cloud accounts.
  * View and analyze them in [AWS](analyze-cost-trends-for-aws.md) and [GCP](analyze-cost-for-gcp.md) tabs.
...
*   To enable CE for AWS and GCP, see [Set Up Cost Visibility for AWS](../setup-cost-visibility/enable-continuous-efficiency-for-aws.md) and [Set Up Cost Visibility for GCP](../setup-cost-visibility/enable-cloud-efficiency-for-google-cloud-platform-gcp.md).
...
* **ECS Service**: The cost of an ECS service that specifies the number of task definition instances running in an Amazon ECS cluster. For a detailed description of ECS services, see [Services](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs\_services.html) from AWS.
...
![](static/analyze-cost-trends-across-clusters-10.png) 2. Select the **date range** for the costs you want to analyze.
...
Forecasted costs are predictions based on your historical cost data. The forecasted date is applicable only where historical data exists. If there is insufficient data to compute the forecast, the value is not displayed. The forecasted cost is predicted for the same future time period as your selected date range. For more information, see [Forecasted Cost](../concepts-ccm/a-cost-explorer-walkthrough.md#forecasted-cost).
...
A measure of how cost-optimized your resource usage is across your clusters. It is derived from the total and idle (and or unallocated) spend of your resources. For more information, see [Efficiency Score](../concepts-ccm/a-cost-explorer-walkthrough.md).
