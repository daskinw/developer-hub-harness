...
description: >-
  You can specify a report sharing schedule to receive your consolidated
  Perspectives weekly cost report.
---
...
2. The **Report Sharing Schedule** settings appear. Follow the steps in [Create a Report Sharing Schedule](share-report-in-cost-perspectives.md) to edit the details of the schedule.
