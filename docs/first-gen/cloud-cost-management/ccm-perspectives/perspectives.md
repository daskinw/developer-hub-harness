...
description: >-
  Harness Continuous Efficiency (CE) Cost Explorer allows you to view,
  understand, and analyze your cloud costs in a simple and intuitive interface.
  You can add business context to all this data using C
---
...
You can add filters using [default fields](perspectives.md#default-fields) or you can [create new custom fields](perspectives.md#custom-fields). As you add your resources in the Perspective Builder, a [Preview](perspectives.md#preview) is displayed of your Perspective.
...
6. Once you have added all the filters, you can [add a report sharing schedule](share-report-in-cost-perspectives.md).
...
4. Follow the steps in add filters using [default fields](perspectives.md#default-fields) or [create new custom fields](perspectives.md#custom-fields) to edit the settings.
