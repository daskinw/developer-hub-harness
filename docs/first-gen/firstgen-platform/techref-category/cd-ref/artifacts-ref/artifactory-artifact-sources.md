...
description: >-
  This topic provides settings and permissions for the Artifactory Artifact
  Servers and Sources. Artifactory Permissions. Make sure the following
  permissions are granted to the user --  Privileged User
---
...
:::note If you are new to using Artifactory as a Docker repo, see [Getting Started with Artifactory as a Docker Registry](https://www.jfrog.com/confluence/display/RTF6X/Getting+Started+with+Artifactory+as+a+Docker+Registry) from JFrog. :::
...
For most artifacts, use \*\*https://mycompany.jfrog.io/\*\*_**module\_name**_.

In some cases, you can use \*\*https://_**server\_name**_/artifactory/\*\*_**module\_name**_.
...
:::note This option is in [TAS (PCF) Services](../../../../continuous-delivery/pcf-deployments/pcf-tutorial-overview.md) only. :::
