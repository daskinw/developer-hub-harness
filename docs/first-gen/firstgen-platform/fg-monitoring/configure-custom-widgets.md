...
description: >-
  You can add Primary and Custom Widgets to your Custom Dashboards. Custom
  Widgets offer less predefined structure than Primary Widgets but offers more
  flexibility. In this topic --  Before You Begin. S
---
...
* You can use a Tag whose name or value uses an expression, but you can only filter or group by Tag _name_.
...
[Account Administrators](configure-custom-widgets.md#administrators) can edit the existing Widgets.
...
[Account Administrators](configure-custom-widgets.md#administrators) can Remove the existing Widgets. **Remove** deletes the Widget from this Custom Dashboard.
