...
description: >-
  Connect your Kubernetes cluster where you will deploy your services using
  Harness.
---
...
* [Before You Begin](add-kubernetes-cluster-cloud-provider.md#before-you-begin)
* [Visual Summary](add-kubernetes-cluster-cloud-provider.md#visual-summary)
* [Review: Using a Delegate Inside or Outside of the Target Cluster](add-kubernetes-cluster-cloud-provider.md#review-using-a-delegate-inside-or-outside-of-the-target-cluster)
  * [Using Non-Kubernetes Delegates](add-kubernetes-cluster-cloud-provider.md#using-non-kubernetes-delegates)
* [Review: Kubernetes Cluster Cloud Provider vs Platform Cloud Providers](add-kubernetes-cluster-cloud-provider.md#review-kubernetes-cluster-cloud-provider-vs-platform-cloud-providers)
* [Review: Permissions for the Kubernetes Role](add-kubernetes-cluster-cloud-provider.md#review-permissions-for-the-kubernetes-role)
* [Step 1: Add the Cloud Provider](add-kubernetes-cluster-cloud-provider.md#step-1-add-the-cloud-provider)
* [Step 2: Cluster Details](add-kubernetes-cluster-cloud-provider.md#step-2-cluster-details)
* [Option 1: Inherit from selected Delegate](add-kubernetes-cluster-cloud-provider.md#option-1-inherit-from-selected-delegate)
* [Option 2: Enter manually](add-kubernetes-cluster-cloud-provider.md#option-2-enter-manually)
  * [Master URL](add-kubernetes-cluster-cloud-provider.md#master-url)
  * [Username and Password](add-kubernetes-cluster-cloud-provider.md#username-and-password)
  * [Service Account Token](add-kubernetes-cluster-cloud-provider.md#service-account-token)
    * [Encrypted CA Certificate (Deprecated)](add-kubernetes-cluster-cloud-provider.md#encrypted-ca-certificate-deprecated)
  * [Custom](add-kubernetes-cluster-cloud-provider.md#custom)
    * [CA Certificate](add-kubernetes-cluster-cloud-provider.md#ca-certificate)
    * [Client Certificate](add-kubernetes-cluster-cloud-provider.md#client-certificate)
    * [Client Key](add-kubernetes-cluster-cloud-provider.md#client-key)
    * [Client Key Passphrase](add-kubernetes-cluster-cloud-provider.md#client-key-passphrase)
    * [Client Key Algorithm](add-kubernetes-cluster-cloud-provider.md#client-key-algorithm)
  * [OIDC Token](add-kubernetes-cluster-cloud-provider.md#oidc-token)
* [Step 3: Skip Validation](add-kubernetes-cluster-cloud-provider.md#step-3-skip-validation)
* [Step 4: Credential Validation](add-kubernetes-cluster-cloud-provider.md#step-4-credential-validation)
* [Review: Permissions Required](add-kubernetes-cluster-cloud-provider.md#review-permissions-required)
  * [Kubernetes Permissions Depend in What You Are Deploying](add-kubernetes-cluster-cloud-provider.md#kubernetes-permissions-depend-in-what-you-are-deploying)
* [Option: AWS EKS Support](add-kubernetes-cluster-cloud-provider.md#option-aws-eks-support)
* [Option: OpenShift Support](add-kubernetes-cluster-cloud-provider.md#option-openshift-support)
  * [OpenShift Notes](add-kubernetes-cluster-cloud-provider.md#openshift-notes)
...
:::note In the case of some Kubernetes providers, such as OpenShift, the Delegate should be installed outside of the cluster. :::
...
:::note This is not used, typically. Some cloud providers have Basic authentication disabled by default. The cluster would need Basic authentication enabled and a specific username and password configured for authentication. ::: :::tip For OpenShift or any other platform, this is not the username/password for the platform. It is the username/password for the cluster. :::
...
:::note This setting affects credential validation only. Harness will always verify network connectivity.Enable this option during _creation_ of the Cloud Provider only. :::
...
:::note The exact API versions depends on the Kubernetes cluster version that evolves over time as entity types get promoted. :::
