...
description: >-
  You can receive Harness notifications in your Slack channels. You simply add a
  Slack Incoming Webhook into a Harness User Groups' Notification Settings. Then
  you can add your User Group to a Workflow…
---
...
* [Before You Begin](send-notification-using-slack.md#before-you-begin)
* [Visual Summary](send-notification-using-slack.md#visual-summary)
* [Step 1: Create a Slack App and Webhook for your Channel](send-notification-using-slack.md#step-1-create-a-slack-app-and-webhook-for-your-channel)
* [Step 2: Add the Webhook to the User Group Notification Settings](send-notification-using-slack.md#step-2-add-the-webhook-to-the-user-group-notification-settings)
* [Related Topics](send-notification-using-slack.md#related-topics)
...
[![](static/send-notification-using-slack-01.png)](static/send-notification-using-slack-01.png)
...
[![](static/send-notification-using-slack-03.png)](static/send-notification-using-slack-03.png)
