...
description: >-
  If you want to run AWS CLI scripts on the Harness Delegate, you need to
  install the AWS CLI on its host(s). For example, you might add a Shell Script
  step in a Workflow that runs AWS CLI commands to…
---

# Install the AWS CLI on a Delegate

import image\_1 from './static/install-the-aws-cli-on-a-delegate-41.png' import image\_2 from './static/install-the-aws-cli-on-a-delegate-42.png' import image\_3 from './static/install-the-aws-cli-on-a-delegate-43.png'
...
* [Before You Begin](install-the-aws-cli-on-a-delegate.md#before-you-begin)
* [Step 1: Create Delegate Profile](install-the-aws-cli-on-a-delegate.md#step-1-create-delegate-profile)
* [Step 2: Add AWS CLI Installation Script](install-the-aws-cli-on-a-delegate.md#step-2-add-aws-cli-installation-script)
* [Step 3: Apply Delegate Profile to Delegate](install-the-aws-cli-on-a-delegate.md#step-3-apply-delegate-profile-to-delegate)
* [Step 4: Check Profile Status](install-the-aws-cli-on-a-delegate.md#step-4-check-profile-status)
* [See Also](install-the-aws-cli-on-a-delegate.md#see-also)
...
:::note For information on the **Delegate Requires Approval** setting, see [Approve or Reject Harness Delegates](approve-or-reject-harness-delegates.md). :::
...
:::note If you see the message, `Profile execution log temporarily unavailable. Try again in a few moments`, the Delegate is still applying the script. Simply wait a few more minutes. :::
