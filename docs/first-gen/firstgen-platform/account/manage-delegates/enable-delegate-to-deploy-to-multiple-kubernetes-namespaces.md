...
* [Before You Begin](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#before-you-begin)
* [Visual Summary](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#visual-summary)
* [Review: Harness Connections to Kubernetes](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#review-harness-connections-to-kubernetes)
  * [Inherit from selected Delegate](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#inherit-from-selected-delegate)
  * [Enter Manually](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#enter-manually)
* [Step 1: Create Service Account](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#step-1-create-service-account)
* [Step 2: Create Role and RoleBinding](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#step-2-create-role-and-role-binding)
* [Option 1: Use the Service Account Token](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#option-1-use-the-service-account-token)
* [Option 2: Add Service Account to Delegate Spec](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#option-2-add-service-account-to-delegate-spec)
* [Review: Enable Skip Validation in Kubernetes Cluster Cloud Provider](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#review-enable-skip-validation-in-kubernetescluster-cloud-provider)
* [Notes](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#notes)
* [Next Steps](enable-delegate-to-deploy-to-multiple-kubernetes-namespaces.md#next-steps)
...
:::note Providing the **Master URL** is mandatory. This is the Kubernetes master node URL. :::
