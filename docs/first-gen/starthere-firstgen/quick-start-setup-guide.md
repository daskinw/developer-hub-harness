...
:::warning This content is for [Harness FirstGen](../../continuous-delivery/get-started/upgrading/upgrade-nextgen-cd.md). Switch to [NextGen](../../platform/get-started/harness-ui-overview/). :::
...
:::note While we use a specific artifact and deployment environment in this guide, the steps are very similar for all the service providers and deployment environments Harness supports. :::
...
4. From **Build / Version** menu, select any **Build#**. ![](static/quick-start-setup-guide-20.png)
...
Now that you've installed the Harness Sample App, proceed to our [Tour Harness Manager](meet-harness.md) topic or one of the [Quickstarts](../../category/quickstarts/).
