...
description: >-
  As an alternative to entering your ECS task and/or service definitions inline
  , you can use your Git repo for task and/or service definition JSON files. At
  deployment runtime, Harness will pull these…
---
...
* For EC2, the required `${DOCKER_IMAGE_NAME}` placeholder must be in your task definition. See [Review: Task Definition Placeholders](use-ecs-task-and-service-definitions-in-git-repos.md#review\_task\_definition\_placeholders) below.
* For Fargate, the required `${EXECUTION_ROLE}` placeholder must be in your task definition. See [Review: Task Definition Placeholders](use-ecs-task-and-service-definitions-in-git-repos.md#review\_task\_definition\_placeholders) below.
...
* [`${DOCKER_IMAGE_NAME}`](use-ecs-task-and-service-definitions-in-git-repos.md#docker\_image\_name)
* [`${CONTAINER_NAME}`](use-ecs-task-and-service-definitions-in-git-repos.md#container\_name)
* [`${EXECUTION_ROLE}`](use-ecs-task-and-service-definitions-in-git-repos.md#execution\_role)
...
In most cases, you can simply leave the placeholder as is.For more information, see  [Amazon ECS Task Execution IAM Role](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task\_execution\_IAM\_role.html) from AWS. |
