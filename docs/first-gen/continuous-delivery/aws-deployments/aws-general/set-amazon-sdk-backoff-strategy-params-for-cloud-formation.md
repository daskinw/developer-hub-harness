...
| `AmazonSDKDefaultBackoffStrategy_baseDelay`          | `100` ms          | Base delay for _FullJitterBackoffStrategy._                         |
| `AmazonSDKDefaultBackoffStrategy_maxBackoff`         | `20000` ms        | The maximum backoff time after which retries will not be performed. |
| `AmazonSDKDefaultBackoffStrategy_throttledBaseDelay` | `500` ms          | Base delay for _EqualJitterBackoffStrategy._                        |
