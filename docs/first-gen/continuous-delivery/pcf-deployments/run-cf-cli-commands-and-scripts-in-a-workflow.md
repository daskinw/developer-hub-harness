...
description: >-
  You can use the CF Command to run any CF CLI command or script at any point in
  your Harness PCF Workflows.
---
...
11. Recommended: Add a Delegate Selector in **Run only on delegates having the following selectors**, as described in [Delegate Selectors](run-cf-cli-commands-and-scripts-in-a-workflow.md#delegate\_selectors).
