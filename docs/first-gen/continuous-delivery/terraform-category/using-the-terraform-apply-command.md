...
description: >-
  Use the Terraform Apply step to perform Terraform operations at any point in
  your Workflow.
---
...
For two Terraform Apply steps to use the _same_ local state file, they must use the same criteria:
