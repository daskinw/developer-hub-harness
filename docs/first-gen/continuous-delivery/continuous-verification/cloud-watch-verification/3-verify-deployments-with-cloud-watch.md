...
description: >-
  Harness can analyze CloudWatch data to verify, rollback, and improve
  deployments.
---
...
This drop-down menu contains the available EC2 metrics. Select the metrics to monitor. For more information, see [Using Amazon CloudWatch Metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/working\_with\_metrics.html) from AWS.
