...
description: >-
  Use CV Custom Metrics to monitor risks and anomalies that occur during the
...
* See  [What Is Continuous Verification (CV)?](what-is-cv/).
* See  [Custom Verification Integrations Overview](../../custom-metrics-and-logs-verification/custom-verification-overview/).
