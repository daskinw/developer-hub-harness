...
description: >-
  Harness can analyze Prometheus data to verify, rollback, and improve
  deployments.
---
...
Every time series is uniquely identified by its metric name and a set of key-value pairs, also known as labels. For more information, see [Data Model](https://prometheus.io/docs/concepts/data\_model/) from Prometheus. A metric requires the following parameters:
