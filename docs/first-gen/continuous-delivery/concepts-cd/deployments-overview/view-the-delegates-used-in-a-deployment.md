...
description: >-
  This content is for Harness FirstGen. Switch to NextGen. Each task performed
  by a Harness deployment is assigned to a Delegate. Knowing which Delegate was
  used for a task can be useful when diagnosin…
---

# View the Delegates Used in a Deployment

This content is for [Harness FirstGen](../../../../continuous-delivery/get-started/upgrading/upgrade-nextgen-cd.md). For information about delegates in Harness NextGen, see [Delegate overview](../../../../platform/delegates/delegate-concepts/delegate-overview.md).
