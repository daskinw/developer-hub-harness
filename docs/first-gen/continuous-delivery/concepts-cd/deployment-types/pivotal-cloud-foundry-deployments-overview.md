...
For detailed instructions on using TAS in Harness, see the [Tanzu Application Service How-tos](../../../../category/iis-net-deployments/).
...
| 8        | Deploy the Workflow.                                                                                                   | <p>Once you've deployed a Workflow, learn how to improve your TAS CD:<br>•  <a href="../../model-cd-pipeline/workflows/workflow-configuration.md">Workflows</a><br>•  <a href="../../model-cd-pipeline/triggers/add-a-trigger-2.md">Triggers</a><br>•  <a href="../../model-cd-pipeline/infrastructure-provisioner/add-an-infra-provisioner.md">Infrastructure Provisioners Overview</a></p>                                                                                                         |
...
* [TAS How-tos](../../../../category/iis-net-deployments/)
