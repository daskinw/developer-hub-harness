...
description: >-
  Dynamically select specific target hosts at deploy time, when starting or
  rerunning a traditional (SSH) deployment.
---
...
* Available only in Basic, Canary, or Rolling Workflows that deploy a _single_ Harness SSH or WinRM Service.
...
![](static/specific-hosts-20.png)To double-check that you've selected individual hosts, you can reopen the [Search](specific-hosts.md#search) box, and find these hosts by substring.
