...
* [Artifact Build and Deploy Pipelines](../../../../category/cicd-artifact-build-and-deploy-pipelines/) — Review these How-tos to learn about CI/CD integration in Harness.
...
You can use the same method to run other third party automated testing tools _that can be packaged as a Docker image_, such as jmeter.
...
This use case is a variation of [Use Case 2: Use Third Party Testing Tools](integrate-tests-into-harness-workflows.md#use\_case\_2\_use\_third\_party\_testing\_tools).
