...
description: >-
  Harness provides deployment support for all of the major platforms, listed in
  the ​Continuous Delivery category. In some cases, you might be using a
  platform that does not have first class support…
---

# Create a Custom Deployment using Deployment Templates

Harness provides deployment support for all of the major platforms, listed in the [Continuous Delivery](../../../category/continuous-delivery/) category.
...
This example uses AWS. Harness already has full, first-class support for AWS deployments. We just use this script as an example. See the AWS Quickstarts in [Start Here](../../../category/quickstarts/).
