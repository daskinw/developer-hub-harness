...
description: >-
  This article addresses some frequently asked questions about Harness GraphQL
  APIs.
---
...
* [Before You Begin](harness-graph-ql-api-faqs.md#before-you-begin)
* [General](harness-graph-ql-api-faqs.md#general)
  * [Why Harness uses GraphQL APIs?](harness-graph-ql-api-faqs.md#why-harness-uses-graphql-apis)
  * [Where do I construct API queries and see responses?](harness-graph-ql-api-faqs.md#where-do-i-construct-api-queries-and-see-responses)
  * [How do I fetch data using GraphQL APIs?](harness-graph-ql-api-faqs.md#how-do-i-fetch-data-using-graphql-apis)
  * [How do I write data using GraphQL APIs?](harness-graph-ql-api-faqs.md#how-do-i-write-data-using-graphql-apis)
  * [Is `clientMutationId` a mandatory parameter?](harness-graph-ql-api-faqs.md#is-clientmutationid-a-mandatory-parameter)
  * [How does Harness GraphQL API factor dynamic values out of the query?](harness-graph-ql-api-faqs.md#how-does-harness-graphql-api-factor-dynamic-values-out-of-the-query)
  * [Does Harness impose Rate/Data Limiting?](harness-graph-ql-api-faqs.md#does-harness-impose-ratedata-limiting)
    * [Cloudflare Rate Limiting](harness-graph-ql-api-faqs.md#cloudflare-rate-limiting)
  * [What does API in beta mean?](harness-graph-ql-api-faqs.md#what-does-api-in-beta-mean)
  * [Where can I find a list of deprecated API features?](harness-graph-ql-api-faqs.md#where-can-i-find-a-list-of-deprecated-api-features)
  * [How do I share any feedback on Harness GraphQL APIs?](harness-graph-ql-api-faqs.md#how-do-i-share-any-feedback-on-harness-graphql-apis)
* [Building Applications Using Postman](harness-graph-ql-api-faqs.md#building-applications-using-postman)
  * [Can I query Harness GraphQL in Postman?](harness-graph-ql-api-faqs.md#can-i-query-harness-graphql-in-postman)
  * [How do I convert my query into the programming language of my choice in Postman?](harness-graph-ql-api-faqs.md#how-do-i-convert-my-query-into-the-programming-language-of-my-choice-in-postman)
* [Authentication](harness-graph-ql-api-faqs.md#authentication)
  * [How do I authenticate in Harness API Explorer?](harness-graph-ql-api-faqs.md#how-do-i-authenticate-in-harness-api-explorer)
* [Cloud Provider APIs](harness-graph-ql-api-faqs.md#cloud-provider-apis)
  * [Can I create, read, update, and delete Harness Cloud Providers using Harness GraphQL APIs?](harness-graph-ql-api-faqs.md#can-i-create-read-update-and-delete-harness-cloud-providers-using-harness-graphql-apis)
  * [How to search for Cloud Provider by ID?](harness-graph-ql-api-faqs.md#how-to-search-for-cloud-provider-by-id)
  * [Can I find all Cloud Providers by type using Harness API?](harness-graph-ql-api-faqs.md#can-i-find-all-cloud-providers-by-type-using-harness-api)
  * [How to find Cloud Provider by name?](harness-graph-ql-api-faqs.md#how-to-find-cloud-provider-by-name)
* [Artifact Source APIs](harness-graph-ql-api-faqs.md#artifact-source-apis)
  * [Can I fetch Artifact Source details using GraphQL APIs?](harness-graph-ql-api-faqs.md#can-i-fetch-artifact-source-details-using-graphql-apis)
  * [How to fetch Artifact Source from a Service using APIs?](harness-graph-ql-api-faqs.md#how-to-fetch-artifact-source-from-a-service-using-apis)
  * [What is the query used to fetch Artifact Source ID from an Artifact?](harness-graph-ql-api-faqs.md#what-is-the-query-used-to-fetch-artifact-source-id-from-an-artifact)
* [Artifact Type APIs](harness-graph-ql-api-faqs.md#artifact-type-apis)
  * [Can I fetch Artifact Type details using GraphQL APIs?](harness-graph-ql-api-faqs.md#can-i-fetch-artifact-type-details-using-graphql-apis)
  * [What are the supported Artifact Types?](harness-graph-ql-api-faqs.md#what-are-the-supported-artifact-types)
* [Harness Applications API](harness-graph-ql-api-faqs.md#harness-applications-api)
  * [What are the different actions that I can perform using Harness Applications API?](harness-graph-ql-api-faqs.md#what-are-the-different-actions-that-i-can-perform-using-harness-applications-api)
  * [How do I use API to retrieve IDs by name?](harness-graph-ql-api-faqs.md#how-do-i-use-api-to-retrieve-ids-by-name)
* [Workflow APIs](harness-graph-ql-api-faqs.md#workflow-apis)
  * [Can I get Workflow details using GraphQL APIs?](harness-graph-ql-api-faqs.md#can-i-get-workflow-details-using-graphql-apis)
  * [How to see executions for a given Workflow using Harness APIs?](harness-graph-ql-api-faqs.md#how-to-see-executions-for-a-given-workflow-using-harness-apis)
  * [How can I trigger a Workflow using GraphQL API?](harness-graph-ql-api-faqs.md#how-can-i-trigger-a-workflow-using-graphql-api)
  * [Can I fetch a user by email address using the Harness API?](harness-graph-ql-api-faqs.md#can-i-fetch-a-user-by-email-address-using-the-harness-api)
* [Pipeline APIs](harness-graph-ql-api-faqs.md#pipeline-apis)
  * [What is the query used to fetch Pipeline ID?](harness-graph-ql-api-faqs.md#what-is-the-query-used-to-fetch-pipeline-id)
  * [Can I see details of a Pipeline using Harness API?](harness-graph-ql-api-faqs.md#can-i-see-details-of-a-pipeline-using-harness-api)
* [Service APIs](harness-graph-ql-api-faqs.md#service-apis)
  * [How to fetch the list of Services for a given Application using Services API?](harness-graph-ql-api-faqs.md#how-to-fetch-the-list-of-services-for-a-given-application-using-services-api)
* [Trigger APIs](harness-graph-ql-api-faqs.md#trigger-apis)
...
* [Users and Groups API](harness-graph-ql-api-faqs.md#users-and-groups-api)
  * [Can I create a user and assign them to the Harness User Groups?](harness-graph-ql-api-faqs.md#can-i-create-a-user-and-assign-them-to-the-harness-user-groups)
  * [How to assign permissions to Harness user groups using APIs?](harness-graph-ql-api-faqs.md#how-to-assign-permissions-to-harness-user-groups-using-apis)
  * [How do I use API to retrieve IDs by name?](harness-graph-ql-api-faqs.md#how-do-i-use-api-to-retrieve-ids-by-name-1)
* [Harness Tags](harness-graph-ql-api-faqs.md#harness-tags)
  * [How do I filter Harness entities using Harness Tags?](harness-graph-ql-api-faqs.md#how-do-i-filter-harness-entities-using-harness-tags)
* [Secrets Management](harness-graph-ql-api-faqs.md#secrets-management)
  * [What are the different secret types supported using API?](harness-graph-ql-api-faqs.md#what-are-the-different-secret-types-supported-using-api)
* [Git Connectors](harness-graph-ql-api-faqs.md#git-connectors)
  * [Can I create, read, update, and delete (CRUD) Git Connectors using Harness GraphQL API?](harness-graph-ql-api-faqs.md#can-i-create-read-update-and-delete-crud-git-connectors-using-harness-graphql-api)
