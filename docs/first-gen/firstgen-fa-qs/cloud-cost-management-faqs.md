...
description: "This article addresses some common questions about\_Harness Cloud Cost Management."
---
...
* [Setup](cloud-cost-management-faqs.md#setup)
  * [AWS](cloud-cost-management-faqs.md#aws)
    * [What types of access do you need for my AWS master account?](cloud-cost-management-faqs.md#what-types-of-access-do-you-need-for-my-aws-master-account)
    * [Can I provide you access to a CUR report in my linked account instead?](cloud-cost-management-faqs.md#can-i-provide-you-access-to-a-cur-report-in-my-linked-account-instead)
    * [What types of access do you get to my accounts?](cloud-cost-management-faqs.md#what-types-of-access-do-you-get-to-my-accounts)
    * [Do you import the data into your account?](cloud-cost-management-faqs.md#do-you-import-the-data-into-your-account)
    * [Do I need a Harness Delegate to get started with AWS?](cloud-cost-management-faqs.md#do-i-need-a-harness-delegate-to-get-started-with-aws)
  * [GCP](cloud-cost-management-faqs.md#gcp)
    * [Do you import the data into your BigQuery account?](cloud-cost-management-faqs.md#do-you-import-the-data-into-your-bigquery-account)
    * [What is the typical hierarchy of GCP cost organizations?](cloud-cost-management-faqs.md#what-is-the-typical-hierarchy-of-gcp-cost-organizations)
    * [Do I need a Harness Delegate to get started connecting to GCP?](cloud-cost-management-faqs.md#do-i-need-a-harness-delegate-to-get-started-connecting-to-gcp)
  * [Kubernetes](cloud-cost-management-faqs.md#kubernetes)
    * [Do I need a Harness Delegate to get started with the Kubernetes cluster?](cloud-cost-management-faqs.md#do-i-need-a-harness-delegate-to-get-started-with-the-kubernetes-cluster)
    * [What prerequisites do I need to be aware of? I understand these are part of the installation checks you make, but I’d like to be prepared before I begin.](cloud-cost-management-faqs.md#what-prerequisites-do-i-need-to-be-aware-of-i-understand-these-are-part-of-the-installation-checks-you-make-but-id-like-to-be-prepared-before-i-begin)
    * [Do I need to ensure the Metrics Server is installed for EKS?](cloud-cost-management-faqs.md#do-i-need-to-ensure-the-metrics-server-is-installed-for-eks)
    * [Do I need 8GB of memory for my Delegate? Can I do it with 3GB?](cloud-cost-management-faqs.md#do-i-need-8gb-of-memory-for-my-delegate-can-i-do-it-with-3gb)
* [Azure](cloud-cost-management-faqs.md#azure)
  * [Do I need a Harness Delegate to get started connecting to Azure?](cloud-cost-management-faqs.md#do-i-need-a-harness-delegate-to-get-started-connecting-to-azure)
  * [What types of access do you get to my accounts?](cloud-cost-management-faqs.md#what-types-of-access-do-you-get-to-my-accounts-1)
* [Status](cloud-cost-management-faqs.md#status)
  * [How frequently do you process cost data for the Kubernetes cluster, AWS, and GCP?](cloud-cost-management-faqs.md#how-frequently-do-you-process-cost-data-for-the-kubernetes-cluster-aws-and-gcp)
  * [How long do I need to wait before data appears for the Kubernetes cluster?](cloud-cost-management-faqs.md#how-long-do-i-need-to-wait-before-data-appears-for-the-kubernetes-cluster)
  * [How long do I need to wait before data appears for AWS? Why?](cloud-cost-management-faqs.md#how-long-do-i-need-to-wait-before-data-appears-for-aws-why)
  * [How long do I need to wait before data appears for GCP? Why?](cloud-cost-management-faqs.md#how-long-do-i-need-to-wait-before-data-appears-for-gcp-why)
  * [How often is data processed overall in CCM?](cloud-cost-management-faqs.md#how-often-is-data-processed-overall-in-ccm)
  * [Why can’t I see my data in the past 2 hours?](cloud-cost-management-faqs.md#why-cant-i-see-my-data-in-the-past-2-hours)
  * [Why is my cluster data showing events last collected since \<x days/hours> ago?](cloud-cost-management-faqs.md#why-is-my-cluster-data-showing-events-last-collected-since-x-dayshours-ago)
* [Efficiency Score](cloud-cost-management-faqs.md#efficiency-score)
  * [Is the efficiency score configurable? Why not?](cloud-cost-management-faqs.md#is-the-efficiency-score-configurable-why-not)
  * [Does the efficiency score take into account overall cloud costs? How is it computed?](cloud-cost-management-faqs.md#does-the-efficiency-score-take-into-account-overall-cloud-costs-how-is-it-computed)
* [Idle Cost](cloud-cost-management-faqs.md#idle-cost)
  * [What specific actions can I take to bring my idle costs down?](cloud-cost-management-faqs.md#what-specific-actions-can-i-take-to-bring-my-idle-costs-down)
* [Unallocated Cost](cloud-cost-management-faqs.md#unallocated-cost)
  * [What specific actions can I take to bring my unallocated costs down?](cloud-cost-management-faqs.md#what-specific-actions-can-i-take-to-bring-my-unallocated-costs-down)
* [Recommendations](cloud-cost-management-faqs.md#recommendations)
  * [Are the recommendations configurable?](cloud-cost-management-faqs.md#are-the-recommendations-configurable)
  * [How do the recommendations compare to Vertical Pod Autoscaler (VPA)?](cloud-cost-management-faqs.md#how-do-the-recommendations-compare-to-vertical-pod-autoscaler-vpa)
  * [What are the key differences between burstable and guaranteed? When do I need to apply which?](cloud-cost-management-faqs.md#what-are-the-key-differences-between-burstable-and-guaranteed-when-do-i-need-to-apply-which)
  * [Can you automate how it is applied?](cloud-cost-management-faqs.md#can-you-automate-how-it-is-applied)
  * [Do you take into account the seasonality and trends of my workload data?](cloud-cost-management-faqs.md#do-you-take-into-account-the-seasonality-and-trends-of-my-workload-data)
  * [What about Horizontal Pod Autoscaler (HPA)?](cloud-cost-management-faqs.md#what-about-horizontal-pod-autoscaler-hpa)
* [Cost Events](cloud-cost-management-faqs.md#cost-events)
  * [What types of events does CCM handle today?](cloud-cost-management-faqs.md#what-types-of-events-does-ccm-handle-today)
  * [How are these relevant to help me cut costs?](cloud-cost-management-faqs.md#how-are-these-relevant-to-help-me-cut-costs)
* [Node Optimization](cloud-cost-management-faqs.md#node-optimization)
  * [How can I optimize my nodes based on the information I get from CE?](cloud-cost-management-faqs.md#how-can-i-optimize-my-nodes-based-on-the-information-i-get-from-ce)
  * [Do I get a spot or on-demand recommendations today?](cloud-cost-management-faqs.md#do-i-get-a-spot-or-on-demand-recommendations-today)
* [Non-cluster](cloud-cost-management-faqs.md#non-cluster)
  * [AWS](cloud-cost-management-faqs.md#aws-1)
  * [Does CCM tie cost data back into the savings plan in AWS?](cloud-cost-management-faqs.md#does-ccm-tie-cost-data-back-into-the-savings-plan-in-aws)
    * [Does CCM tie cost data to make Reserved Instance (RI) recommendations?](cloud-cost-management-faqs.md#does-ccm-tie-cost-data-to-make-reserved-instance-ri-recommendations)
    * [Does CCM take into account my RI purchases and discounts?](cloud-cost-management-faqs.md#does-ccm-take-into-account-my-ri-purchases-and-discounts)
  * [GCP](cloud-cost-management-faqs.md#gcp-1)
    * [Does CCM take into account Committed Usage Discounts (CUDs), Sustained Use Discounts (SUDs)?](cloud-cost-management-faqs.md#does-ccm-take-into-account-committed-usage-discounts-cuds-sustained-use-discounts-suds)
    * [Does CCM take into account custom discounts or rewards?](cloud-cost-management-faqs.md#does-ccm-take-into-account-custom-discounts-or-rewards)
    * [What about some services I purchased via the marketplace?](cloud-cost-management-faqs.md#what-about-some-services-i-purchased-via-the-marketplace)
* [Reporting/Scheduling and Cost Governance](cloud-cost-management-faqs.md#reportingscheduling-and-cost-governance)
  * [Do you support custom reporting to our finance teams?](cloud-cost-management-faqs.md#do-you-support-custom-reporting-to-our-finance-teams)
  * [Do you support custom dashboard creation? What if I want to share configurable dashboards on a scheduled basis to my business users?](cloud-cost-management-faqs.md#do-you-support-custom-dashboard-creation-what-if-i-want-to-share-configurable-dashboards-on-a-scheduled-basis-to-my-business-users)
* [On-premise and Other Clouds](cloud-cost-management-faqs.md#on-premise-and-other-clouds)
  * [Does CCM support on-prem workloads? What about the other types of infra? OpenShift, VMware, etc.?](cloud-cost-management-faqs.md#does-ccm-support-on-prem-workloads-what-about-the-other-types-of-infra-openshift-vmware-etc)
  * [Can I manually enter cost data or upload a rate card?](cloud-cost-management-faqs.md#can-i-manually-enter-cost-data-or-upload-a-rate-card)
  * [What about other clouds? IBM, Oracle, etc.? Do you support the Kubernetes cluster running on these clouds?](cloud-cost-management-faqs.md#what-about-other-clouds-ibm-oracle-etc-do-you-support-the-kubernetes-cluster-running-on-these-clouds)
* [APIs](cloud-cost-management-faqs.md#apis)
  * [Can we export CCM data?](cloud-cost-management-faqs.md#can-we-export-ccm-data)
* [Cost Anomaly Detection](cloud-cost-management-faqs.md#cost-anomaly-detection)
  * [Does CCM detects cost spikes and cost drops?](cloud-cost-management-faqs.md#does-ccm-detects-cost-spikes-and-cost-drops)
  * [How many days of data does CCM analyze to predict the cost anomalies?](cloud-cost-management-faqs.md#how-many-days-of-data-does-ccm-analyze-to-predict-the-cost-anomalies)
  * [How does cost anomaly detection works?](cloud-cost-management-faqs.md#how-does-cost-anomaly-detection-works)
  * [Can I change the thresholds defined in the algorithm?](cloud-cost-management-faqs.md#can-i-change-the-thresholds-defined-in-the-algorithm)
  * [Does the cost anomaly detection algorithm keep an account of the recurring events (seasonalities) that happen on a daily, weekly, or monthly basis?](cloud-cost-management-faqs.md#does-the-cost-anomaly-detection-algorithm-keep-an-account-of-the-recurring-events-seasonalities-that-happen-on-a-daily-weekly-or-monthly-basis)
  * [Does Harness CCM send notifications for the cost anomalies?](cloud-cost-management-faqs.md#does-harness-ccm-send-notifications-for-the-cost-anomalies)
* [General](cloud-cost-management-faqs.md#general)
  * [What is the typical hierarchy of AWS/GCP/Azure?](cloud-cost-management-faqs.md#what-is-the-typical-hierarchy-of-awsgcpazure)
...
2. If autoscaler is enabled on GKE it can be [tweaked](https://cloud.google.com/kubernetes-engine/docs/concepts/cluster-autoscaler#autoscaling\_profiles) to scale down.
...
For information about this support in Harness NG, go to [CE Coverage](../../cloud-cost-management/get-started/overview.md#ccm-coverage) and [What's supported in CCM](../../cloud-cost-management/whats-supported.md).
