...
description: >-
  ...
  Continuous Verification (CV). Before You Begin. Harness Key Concepts.
  Supported Platforms and Technologies. General. For an overvi…
---
...
* [Before You Begin](continuous-verification-faqs.md#before-you-begin)
* [General](continuous-verification-faqs.md#general)
  * [How can Harness help verify my applications and services?](continuous-verification-faqs.md#how-can-harness-help-verify-my-applications-and-services)
  * [What does Harness do with my APM/Time-Series data?](continuous-verification-faqs.md#what-does-harness-do-with-my-apmtime-series-data)
  * [What does Harness do with my log data?](continuous-verification-faqs.md#what-does-harness-do-with-my-log-data)
  * [Why Perform Continuous Verification?](continuous-verification-faqs.md#why-perform-continuous-verification)
  * [How is Harness more dynamic than rules-based learning?](continuous-verification-faqs.md#how-is-harness-more-dynamic-than-rules-based-learning)
  * [Does Harness use Machine Learning (ML)?](continuous-verification-faqs.md#does-harness-use-machine-learning-ml)
* [24/7 Service Guard](continuous-verification-faqs.md#247-service-guard)
  * [What is Harness 24/7 Service Guard?](continuous-verification-faqs.md#what-is-harness-247-service-guard)
  * [Does 24/7 Service Guard show deployment verifications?](continuous-verification-faqs.md#does-247-service-guard-show-deployment-verifications)
  * [What can I see in the 24/7 Service Guard dashboard?](continuous-verification-faqs.md#what-can-i-see-in-the-247-service-guard-dashboard)
* [Verifying Deployments](continuous-verification-faqs.md#verifying-deployments)
  * [When Does Harness Verify Deployments?](continuous-verification-faqs.md#when-does-harness-verify-deployments)
  * [How Does Harness Perform Continuous Verification?](continuous-verification-faqs.md#how-does-harness-perform-continuous-verification)
  * [What is Previous Analysis?](continuous-verification-faqs.md#what-is-previous-analysis)
  * [Can I change the baseline for Previous Analysis?](continuous-verification-faqs.md#can-i-change-the-baseline-for-previous-analysis)
  * [What is Analysis Time Duration?](continuous-verification-faqs.md#what-is-analysis-time-duration)
  * [Which providers support each analysis strategy?](continuous-verification-faqs.md#which-providers-support-each-analysis-strategy)
  * [What Harness deployment strategy supports each analysis strategy?](continuous-verification-faqs.md#what-harness-deployment-strategy-supports-each-analysis-strategy)
  * [Are there verification Best Practices?](continuous-verification-faqs.md#are-there-verification-best-practices)
* [Verification Results](continuous-verification-faqs.md#verification-results)
  * [What are some of the verification results?](continuous-verification-faqs.md#what-are-some-of-the-verification-results)
* [Tuning Verification Feedback](continuous-verification-faqs.md#tuning-verification-feedback)
  * [Can I tune the verification results to improve analysis?](continuous-verification-faqs.md#can-i-tune-the-verification-results-to-improve-analysis)
  * [How do I tune feedback?](continuous-verification-faqs.md#how-do-i-tune-feedback)
  * [Can I tune thresholds?](continuous-verification-faqs.md#can-i-tune-thresholds)
  * [Can I see the API calls performed during verification?](continuous-verification-faqs.md#can-i-see-the-api-calls-performed-during-verification)
  * [Can I file tickets on verification events?](continuous-verification-faqs.md#can-i-file-tickets-on-verification-events)
* [Continuous Verification Metric Types](continuous-verification-faqs.md#continuous-verification-metric-types)
  * [How do you identify anomalies?](continuous-verification-faqs.md#how-do-you-identify-anomalies)
* [AppDynamics Verification](continuous-verification-faqs.md#appdynamics-verification)
  * [How do you integrate with AppDynamics?](continuous-verification-faqs.md#how-do-you-integrate-with-appdynamics)
  * [Do you support AppDynamics Lite?](continuous-verification-faqs.md#do-you-support-appdynamics-lite)
  * [Can I reuse my AppDynamics verification setup?](continuous-verification-faqs.md#can-i-reuse-my-appdynamics-verification-setup)
  * [Can I use Harness to set required Controller environment variables?](continuous-verification-faqs.md#can-i-use-harness-to-set-required-controller-environment-variables)
* [Bugsnag Verification](continuous-verification-faqs.md#bugsnag-verification)
  * [How do you integrate with Bugsnag?](continuous-verification-faqs.md#how-do-you-integrate-with-bugsnag)
  * [Can you monitor my browser-based apps with Bugsnag?](continuous-verification-faqs.md#can-you-monitor-my-browser-based-apps-with-bugsnag)
* [CloudWatch Verification](continuous-verification-faqs.md#cloudwatch-verification)
  * [How do you integrate with CloudWatch?](continuous-verification-faqs.md#how-do-you-integrate-with-cloudwatch)
  * [What CloudWatch metrics can I use for Verification?](continuous-verification-faqs.md#what-cloudwatch-metrics-can-i-use-for-verification)
* [Datadog Verification](continuous-verification-faqs.md#datadog-verification)
  * [How do you integrate with Datadog?](continuous-verification-faqs.md#how-do-you-integrate-with-datadog)
  * [What platforms are supported for Datadog verification?](continuous-verification-faqs.md#what-platforms-are-supported-for-datadog-verification)
* [Dynatrace Verification](continuous-verification-faqs.md#dynatrace-verification)
  * [How do you integrate with Dynatrace?](continuous-verification-faqs.md#how-do-you-integrate-with-dynatrace)
  * [Is there a Dynatrace Verification use case?](continuous-verification-faqs.md#is-there-a-dynatrace-verification-use-case)
* [Elasticsearch Verification](continuous-verification-faqs.md#elasticsearch-verification)
  * [How do you integrate with Elasticsearch?](continuous-verification-faqs.md#how-do-you-integrate-with-elasticsearch)
* [Logz.io Verification](continuous-verification-faqs.md#logzio-verification)
  * [How do you integrate with Logz?](continuous-verification-faqs.md#how-do-you-integrate-with-logz)
  * [Can I use Logz Pro or Community?](continuous-verification-faqs.md#can-i-use-logz-pro-or-community)
* [New Relic Verification](continuous-verification-faqs.md#new-relic-verification)
  * [How do you integrate with New Relic?](continuous-verification-faqs.md#how-do-you-integrate-with-new-relic)
  * [What type of transactions can I use?](continuous-verification-faqs.md#what-type-of-transactions-can-i-use)
  * [Can I use a deployment marker?](continuous-verification-faqs.md#can-i-use-a-deployment-marker)
* [Prometheus Verification](continuous-verification-faqs.md#prometheus-verification)
  * [How do you integrate with Prometheus?](continuous-verification-faqs.md#how-do-you-integrate-with-prometheus)
* [Splunk Verification](continuous-verification-faqs.md#splunk-verification)
  * [How do you integrate with Splunk?](continuous-verification-faqs.md#how-do-you-integrate-with-splunk)
* [Google Operations (formerly Stackdriver) Verification](continuous-verification-faqs.md#google-operations-formerly-stackdriver-verification)
  * [How do you integrate with Google Operations?](continuous-verification-faqs.md#how-do-you-integrate-with-google-operations)
* [Sumo Logic Verification](continuous-verification-faqs.md#sumo-logic-verification)
  * [How do you integrate with Sumo Logic?](continuous-verification-faqs.md#how-do-you-integrate-with-sumo-logic)
* [Instana Verification](continuous-verification-faqs.md#instana-verification)
  * [How do you integrate with Instana?](continuous-verification-faqs.md#how-do-you-integrate-with-instana)
* [Uncommon Metrics and Logging Providers](continuous-verification-faqs.md#uncommon-metrics-and-logging-providers)
  * [How do you integrate with other metrics and logging provider?](continuous-verification-faqs.md#how-do-you-integrate-with-other-metrics-and-logging-provider)
...
Harness' semi-supervised ML takes this approach a step further. You can tune Harness' learning engine to generate alerts targeted to _your_ service and environment. Compared to coarse, basic rules, this provides a much more flexible basis for pausing or rolling back deployments.
