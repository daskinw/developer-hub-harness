...
description: >-
  This article addresses some frequently asked questions about Harness
  Continuous Deployments (CD). Before You Begin. General. AWS AMI/ASG. AWS
  AMI/ASG with Spotinst. AWS ECS. AWS CloudFormation. AWS L…
---
...
* [Before You Begin](continuous-deployment-faqs.md#before-you-begin)
* [General](continuous-deployment-faqs.md#general)
  * [What can I deploy using Harness?](continuous-deployment-faqs.md#what-can-i-deploy-using-harness)
  * [What is a Service Instance in Harness?](continuous-deployment-faqs.md#what-is-a-service-instance-in-harness)
  * [How often does Harness Sync with my Deployed Service Instances?](continuous-deployment-faqs.md#how-often-does-harness-sync-with-my-deployed-service-instances)
  * [What if I add more Service Instance infrastructure outside of Harness?](continuous-deployment-faqs.md#what-if-i-add-more-service-instance-infrastructure-outside-of-harness)
  * [When is a Service Instance removed?](continuous-deployment-faqs.md#when-is-a-service-instance-removed)
  * [If the instance/pod is in a failed state does it still count towards the service instance count?](continuous-deployment-faqs.md#if-the-instancepod-is-in-a-failed-state-does-it-still-count-towards-the-service-instance-count)
  * [What deployment strategies can I use?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use)
  * [How do I filter deployments on the Deployments page?](continuous-deployment-faqs.md#how-do-i-filter-deployments-on-the-deployments-page)
  * [How do I know which Harness Delegates were used in a deployment?](continuous-deployment-faqs.md#how-do-i-know-which-harness-delegates-were-used-in-a-deployment)
  * [Can I export deployment logs?](continuous-deployment-faqs.md#can-i-export-deployment-logs)
  * [Can I restrict deployments to specific User Groups?](continuous-deployment-faqs.md#can-i-restrict-deployments-to-specific-user-groups)
  * [Can I deploy a Workflow to multiple infrastructures at the same time?](continuous-deployment-faqs.md#can-i-deploy-a-workflow-to-multiple-infrastructures-at-the-same-time)
  * [Can I resume a failed deployment?](continuous-deployment-faqs.md#can-i-resume-a-failed-deployment)
  * [Can I pause all deployments?](continuous-deployment-faqs.md#can-i-pause-all-deployments)
* [AWS AMI/ASG](continuous-deployment-faqs.md#aws-amiasg)
  * [What is a Harness AMI/ASG deployment?](continuous-deployment-faqs.md#what-is-a-harness-amiasg-deployment)
  * [Are public AMIs supported?](continuous-deployment-faqs.md#are-public-amis-supported)
  * [Can I do traffic shifting with AMI/ASG deployments?](continuous-deployment-faqs.md#can-i-do-traffic-shifting-with-amiasg-deployments)
  * [How does Harness rollback and downsize old ASGs?](continuous-deployment-faqs.md#how-does-harness-rollback-and-downsize-old-asgs)
* [AWS AMI/ASG with Spotinst](continuous-deployment-faqs.md#aws-amiasg-with-spotinst)
  * [Do you support Spotinst?](continuous-deployment-faqs.md#do-you-support-spotinst)
  * [Can I do traffic shifting with Spotinst deployments?](continuous-deployment-faqs.md#can-i-do-traffic-shifting-with-spotinst-deployments)
  * [Can I perform verification on Spotinst traffic shifting?](continuous-deployment-faqs.md#can-i-perform-verification-on-spotinst-traffic-shifting)
* [AWS ECS](continuous-deployment-faqs.md#aws-ecs)
  * [What is a Harness ECS deployment?](continuous-deployment-faqs.md#what-is-a-harness-ecs-deployment)
  * [What ECS strategies can I use?](continuous-deployment-faqs.md#what-ecs-strategies-can-i-use)
  * [What deployment strategies can I use?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use-1)
  * [What limitations are there on ECS deployments?](continuous-deployment-faqs.md#what-limitations-are-there-on-ecs-deployments)
  * [Can I do traffic shifting with AMI/ASG deployments?](continuous-deployment-faqs.md#can-i-do-traffic-shifting-with-amiasg-deployments-1)
  * [What ECS networking strategies can I use?](continuous-deployment-faqs.md#what-ecs-networking-strategies-can-i-use)
  * [Do Harness support ECS auto scaling?](continuous-deployment-faqs.md#do-harness-support-ecs-auto-scaling)
  * [Can I use ECS definitions in my repo?](continuous-deployment-faqs.md#can-i-use-ecs-definitions-in-my-repo)
  * [Can I deploy sidecar containers?](continuous-deployment-faqs.md#can-i-deploy-sidecar-containers)
  * [Can I run an ECS task?](continuous-deployment-faqs.md#can-i-run-an-ecs-task)
* [AWS CloudFormation](continuous-deployment-faqs.md#aws-cloudformation)
  * [Does Harness support AWS CloudFormation?](continuous-deployment-faqs.md#does-harness-support-aws-cloudformation)
  * [Do I need to deploy an application to use CloudFormation?](continuous-deployment-faqs.md#do-i-need-to-deploy-an-application-to-use-cloudformation)
  * [Are Harness Service Instances counted with CloudFormation provisioning?](continuous-deployment-faqs.md#are-harness-service-instances-counted-with-cloudformation-provisioning)
  * [Does Harness support AWS Serverless Application Model (SAM) templates?](continuous-deployment-faqs.md#does-harness-support-aws-serverless-application-model-sam-templates)
  * [What deployment strategies can I use CloudFormation with?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use-cloudformation-with)
* [AWS Lambda](continuous-deployment-faqs.md#aws-lambda)
  * [What is a Harness Lambda deployment?](continuous-deployment-faqs.md#what-is-a-harness-lambda-deployment)
  * [How many Service Instances (SIs) would 1 Lambda function consume in Harness?](continuous-deployment-faqs.md#how-many-service-instances-sis-would-1-lambda-function-consume-in-harness)
  * [What artifact servers are support for Lambda deployments?](continuous-deployment-faqs.md#what-artifact-servers-are-support-for-lambda-deployments)
  * [Can I monitor my Lambda function deployments?](continuous-deployment-faqs.md#can-i-monitor-my-lambda-function-deployments)
* [Azure](continuous-deployment-faqs.md#azure)
  * [What Azure deployments does Harness support?](continuous-deployment-faqs.md#what-azure-deployments-does-harness-support)
  * [What does an Azure virtual machine scale set (VMSS) deployment involve?](continuous-deployment-faqs.md#what-does-an-azure-virtual-machine-scale-set-vmss-deployment-involve)
  * [What operation systems are supported for VMSS?](continuous-deployment-faqs.md#what-operation-systems-are-supported-for-vmss)
  * [What deployment strategies can I use with VMSS?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use-with-vmss)
  * [What does an Azure ACR to AKS deployment involve?](continuous-deployment-faqs.md#what-does-an-azure-acr-to-aks-deployment-involve)
* [CI/CD: Artifact Build and Deploy Pipelines](continuous-deployment-faqs.md#cicd-artifact-build-and-deploy-pipelines)
  * [What is a Harness Artifact Build and Deploy deployment?](continuous-deployment-faqs.md#what-is-a-harness-artifact-build-and-deploy-deployment)
  * [What can I deploy using Artifact Build and Deploy?](continuous-deployment-faqs.md#what-can-i-deploy-using-artifact-build-and-deploy)
  * [How do I create the build Workflow?](continuous-deployment-faqs.md#how-do-i-create-the-build-workflow)
  * [How do I create the deploy Workflow?](continuous-deployment-faqs.md#how-do-i-create-the-deploy-workflow)
  * [How do I build the Artifact Build and Deploy Pipeline?](continuous-deployment-faqs.md#how-do-i-build-the-artifact-build-and-deploy-pipeline)
* [Google Cloud Builds](continuous-deployment-faqs.md#google-cloud-builds)
  * [What is a Harness Google Cloud Build deployment?](continuous-deployment-faqs.md#what-is-a-harness-google-cloud-build-deployment)
  * [Can I pull the GCB spec from my repo?](continuous-deployment-faqs.md#can-i-pull-the-gcb-spec-from-my-repo)
  * [Can I use an existing GCB trigger?](continuous-deployment-faqs.md#can-i-use-an-existing-gcb-trigger)
  * [Can I use GCB substitutions?](continuous-deployment-faqs.md#can-i-use-gcb-substitutions)
  * [What formats are supported for config files?](continuous-deployment-faqs.md#what-formats-are-supported-for-config-files)
* [Native Helm](continuous-deployment-faqs.md#native-helm)
  * [What is a Harness Native Helm deployment?](continuous-deployment-faqs.md#what-is-a-harness-native-helm-deployment)
  * [What Helm versions does Harness support?](continuous-deployment-faqs.md#what-helm-versions-does-harness-support)
  * [Can I upgrade my Native Helm deployment from Helm 2 to Helm 3?](continuous-deployment-faqs.md#can-i-upgrade-my-native-helm-deployment-from-helm-2-to-helm-3)
  * [Can I deploy Helm charts without adding an artifact source to Harness?](continuous-deployment-faqs.md#can-i-deploy-helm-charts-without-adding-an-artifact-source-to-harness)
* [IIS (.NET)](continuous-deployment-faqs.md#iis-net)
  * [What is a Harness IIS (.NET) deployment?](continuous-deployment-faqs.md#what-is-a-harness-iis-net-deployment)
  * [How do I set up a WinRM on my target hosts?](continuous-deployment-faqs.md#how-do-i-set-up-a-winrm-on-my-target-hosts)
  * [How do I set up a WinRM connection in Harness?](continuous-deployment-faqs.md#how-do-i-set-up-a-winrm-connection-in-harness)
  * [How do I create a Pipeline that deploys all my IIS components?](continuous-deployment-faqs.md#how-do-i-create-a-pipeline-that-deploys-all-my-iis-components)
* [Kubernetes](continuous-deployment-faqs.md#kubernetes)
  * [What is a Harness Kubernetes deployment?](continuous-deployment-faqs.md#what-is-a-harness-kubernetes-deployment)
  * [What workloads can Harness deploy in a Kubernetes cluster?](continuous-deployment-faqs.md#what-workloads-can-harness-deploy-in-a-kubernetes-cluster)
  * [For Kubernetes, does Harness count only pods as a service instance (SI)? What about a ConfigMap or a Secret?](continuous-deployment-faqs.md#for-kubernetes-does-harness-count-only-pods-as-a-service-instance-si-what-about-a-configmap-or-a-secret)
  * [How is Harness sure that a pod is a service instance?](continuous-deployment-faqs.md#how-is-harness-sure-that-a-pod-is-a-service-instance)
  * [If I create a pod using Harness and keep managing it, is it still counted as a service instance?](continuous-deployment-faqs.md#if-i-create-a-pod-using-harness-and-keep-managing-it-is-it-still-counted-as-a-service-instance)
  * [Does Harness support OpenShift?](continuous-deployment-faqs.md#does-harness-support-openshift)
  * [Can I use Helm?](continuous-deployment-faqs.md#can-i-use-helm)
  * [Can I deploy Helm charts without adding an artifact source to Harness?](continuous-deployment-faqs.md#can-i-deploy-helm-charts-without-adding-an-artifact-source-to-harness-1)
  * [Can I use OpenShift?](continuous-deployment-faqs.md#can-i-use-openshift)
  * [Can I run Kubernetes jobs?](continuous-deployment-faqs.md#can-i-run-kubernetes-jobs)
  * [Can I deploy a Kubernetes resources using CRDs?](continuous-deployment-faqs.md#can-i-deploy-a-kubernetes-resources-using-crds)
  * [Can I deploy resources outside of the main Kubernetes workload?](continuous-deployment-faqs.md#can-i-deploy-resources-outside-of-the-main-kubernetes-workload)
  * [Can I ignore a manifest during deployment?](continuous-deployment-faqs.md#can-i-ignore-a-manifest-during-deployment)
  * [Can I pull an image from a private registry?](continuous-deployment-faqs.md#can-i-pull-an-image-from-a-private-registry)
  * [Can I use remote sources for my manifests?](continuous-deployment-faqs.md#can-i-use-remote-sources-for-my-manifests)
  * [Can I provision Kubernetes infrastructure?](continuous-deployment-faqs.md#can-i-provision-kubernetes-infrastructure)
  * [What deployment strategies can I use with Kubernetes?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use-with-kubernetes)
  * [Can I create namespaces during deployment?](continuous-deployment-faqs.md#can-i-create-namespaces-during-deployment)
  * [Do you support Kustomize?](continuous-deployment-faqs.md#do-you-support-kustomize)
  * [Can I use Ingress traffic routing?](continuous-deployment-faqs.md#can-i-use-ingress-traffic-routing)
  * [Can I perform traffic splitting with Istio?](continuous-deployment-faqs.md#can-i-perform-traffic-splitting-with-istio)
  * [Can I perform traffic splitting without Istio?](continuous-deployment-faqs.md#can-i-perform-traffic-splitting-without-istio)
  * [Can I scale my pods up and down?](continuous-deployment-faqs.md#can-i-scale-my-pods-up-and-down)
  * [How do I delete Kubernetes resources?](continuous-deployment-faqs.md#how-do-i-delete-kubernetes-resources)
  * [Can I use Helm 3 with Kubernetes?](continuous-deployment-faqs.md#can-i-use-helm-3-with-kubernetes)
  * [Can I use Helm Chart Hooks in Kubernetes Deployments?](continuous-deployment-faqs.md#can-i-use-helm-chart-hooks-in-kubernetes-deployments)
* [Tanzu Application Service (TAS)](continuous-deployment-faqs.md#tanzu-application-service-tas)
  * [What is a Harness TAS deployment?](continuous-deployment-faqs.md#what-is-a-harness-tas-deployment)
  * [Can I use TAS plugins?](continuous-deployment-faqs.md#can-i-use-tas-plugins)
  * [Can I use remote resource files?](continuous-deployment-faqs.md#can-i-use-remote-resource-files)
  * [What deployment strategies can I use with TAS?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use-with-tas)
  * [Can I run CF CLI commands and scripts during deployment?](continuous-deployment-faqs.md#can-i-run-cf-cli-commands-and-scripts-during-deployment)
  * [What CF CLI version does Harness support?](continuous-deployment-faqs.md#what-cf-cli-version-does-harness-support)
  * [Can I use the App Autoscaler Service?](continuous-deployment-faqs.md#can-i-use-the-app-autoscaler-service)
* [Terraform](continuous-deployment-faqs.md#terraform)
  * [How does Harness support Terraform?](continuous-deployment-faqs.md#how-does-harness-support-terraform)
  * [Do I need to deploy an application to use Terraform?](continuous-deployment-faqs.md#do-i-need-to-deploy-an-application-to-use-terraform)
  * [Are Harness Service Instances counted with Terraform provisioning?](continuous-deployment-faqs.md#are-harness-service-instances-counted-with-terraform-provisioning)
  * [What deployment strategies can I use Terraform with?](continuous-deployment-faqs.md#what-deployment-strategies-can-i-use-terraform-with)
  * [Can I perform a Terraform dry run?](continuous-deployment-faqs.md#can-i-perform-a-terraform-dry-run)
  * [Can I remove resources provisioned with Terraform?](continuous-deployment-faqs.md#can-i-remove-resources-provisioned-with-terraform)
* [Traditional (SSH)](continuous-deployment-faqs.md#traditional-ssh)
  * [What is a Harness Traditional (SSH) deployment?](continuous-deployment-faqs.md#what-is-a-harness-traditional-ssh-deployment)
  * [Can I add Application Stacks?](continuous-deployment-faqs.md#can-i-add-application-stacks)
  * [Can I add scripts to my Traditional (SSH) deployment?](continuous-deployment-faqs.md#can-i-add-scripts-to-my-traditional-ssh-deployment)
  * [What types of deployment strategies can I use with Traditional (SSH) deployment?](continuous-deployment-faqs.md#what-types-of-deployment-strategies-can-i-use-with-traditional-ssh-deployment)
* [Configure as Code](continuous-deployment-faqs.md#configure-as-code)
  * [Can I create my deployments using YAML?](continuous-deployment-faqs.md#can-i-create-my-deployments-using-yaml)
  * [Can I sync my Harness account or application with my repo?](continuous-deployment-faqs.md#can-i-sync-my-harness-account-or-application-with-my-repo)
  * [Can I view Git sync activity?](continuous-deployment-faqs.md#can-i-view-git-sync-activity)
  * [Can Harness troubleshoot Git sync errors?](continuous-deployment-faqs.md#can-harness-troubleshoot-git-sync-errors)
  * [Does Harness support GitOps?](continuous-deployment-faqs.md#does-harness-support-gitops)
* [Uncommon Deployment Platforms](continuous-deployment-faqs.md#uncommon-deployment-platforms)
  * [What is a Harness Custom Deployment?](continuous-deployment-faqs.md#what-is-a-harness-custom-deployment)
  * [Does Harness support custom artifact repositories?](continuous-deployment-faqs.md#does-harness-support-custom-artifact-repositories)
  * [Does Harness support custom provisioners?](continuous-deployment-faqs.md#does-harness-support-custom-provisioners)
  * [Does Harness support custom approvals?](continuous-deployment-faqs.md#does-harness-support-custom-approvals)
* [Harness Applications](continuous-deployment-faqs.md#harness-applications)
  * [What is a Harness Application?](continuous-deployment-faqs.md#what-is-a-harness-application)
* [Harness Services](continuous-deployment-faqs.md#harness-services)
  * [What is a Harness Service?](continuous-deployment-faqs.md#what-is-a-harness-service)
* [Artifacts](continuous-deployment-faqs.md#artifacts)
  * [What artifact sources can I use?](continuous-deployment-faqs.md#what-artifact-sources-can-i-use)
  * [Does Harness support Azure DevOps?](continuous-deployment-faqs.md#does-harness-support-azure-devops)
* [Harness Environments](continuous-deployment-faqs.md#harness-environments)
  * [What is a Harness Environment?](continuous-deployment-faqs.md#what-is-a-harness-environment)
* [Harness Infrastructure Definitions](continuous-deployment-faqs.md#harness-infrastructure-definitions)
* [Harness Workflows](continuous-deployment-faqs.md#harness-workflows)
  * [What is a Harness Workflow?](continuous-deployment-faqs.md#what-is-a-harness-workflow)
  * [How are deployment strategies implemented as Workflows?](continuous-deployment-faqs.md#how-are-deployment-strategies-implemented-as-workflows)
  * [Are Workflow deployments to the same infrastructure queued?](continuous-deployment-faqs.md#are-workflow-deployments-to-the-same-infrastructure-queued)
* [Harness Pipelines](continuous-deployment-faqs.md#harness-pipelines)
  * [What is a Harness Pipeline?](continuous-deployment-faqs.md#what-is-a-harness-pipeline)
  * [Can I skip Pipeline stages?](continuous-deployment-faqs.md#can-i-skip-pipeline-stages)
  * [Can I create a Pipeline template?](continuous-deployment-faqs.md#can-i-create-a-pipeline-template)
  * [Are Pipeline deployments to the same infrastructure queued?](continuous-deployment-faqs.md#are-pipeline-deployments-to-the-same-infrastructure-queued)
* [Harness Infrastructure Provisioners](continuous-deployment-faqs.md#harness-infrastructure-provisioners)
  * [What is a Harness Infrastructure Provisioner?](continuous-deployment-faqs.md#what-is-a-harness-infrastructure-provisioner)
* [Harness Triggers](continuous-deployment-faqs.md#harness-triggers)
  * [What is a Harness Trigger?](continuous-deployment-faqs.md#what-is-a-harness-trigger)
  * [Can I pause triggers?](continuous-deployment-faqs.md#can-i-pause-triggers)
* [Approvals](continuous-deployment-faqs.md#approvals)
  * [What is a Harness Approval?](continuous-deployment-faqs.md#what-is-a-harness-approval)
  * [What can I use for Approvals?](continuous-deployment-faqs.md#what-can-i-use-for-approvals)
* [Harness Variables Expressions](continuous-deployment-faqs.md#harness-variables-expressions)
  * [What are Harness Variable Expressions?](continuous-deployment-faqs.md#what-are-harness-variable-expressions)
  * [Are there built-in variables?](continuous-deployment-faqs.md#are-there-built-in-variables)
  * [Where can I use variables?](continuous-deployment-faqs.md#where-can-i-use-variables)
  * [Can I pass variables into Workflows and Pipelines?](continuous-deployment-faqs.md#can-i-pass-variables-into-workflows-and-pipelines)
  * [How can I override variables?](continuous-deployment-faqs.md#how-can-i-override-variables)
  * [Can I use JSON and XML in my expressions?](continuous-deployment-faqs.md#can-i-use-json-and-xml-in-my-expressions)
...
Always start with the Quickstarts in [Start Here](../../category/quickstarts/). These will take you from novice to advanced Harness user in a matter of minutes.
...
* [Tanzu Application Service (TAS)](continuous-deployment-faqs.md#tanzu\_application\_service\_tas)
...
* [Configuration as Code](../../category/configuration-as-code/) (work exclusively in YAML and sync with your Git repos)
* [Harness GitOps](../../category/harness-git-based-how-tos/)

For topics on general CD modeling in Harness, see [Model Your CD Pipeline](../../category/model-your-cd-pipeline/).
...
* Remote files must be formatted to meet ECS JSON formatting standards. See [task definition](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task\_definition\_parameters.html) and [service definition](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service\_definition\_parameters.html) parameters from AWS.
...
In addition to this method, you can also simply deploy the Helm chart without adding your artifact to Harness. Instead, the Helm chart identifies the artifact. Harness installs the chart, gets the artifact from the repo, and then installs the artifact. We call this a _Helm chart deployment_.
...
For detailed instructions on using Kubernetes in Harness, see the [Kubernetes How-tos](../../category/kubernetes-deployments/).
...
Yes. You can use [Helm chart hooks](https://helm.sh/docs/topics/charts\_hooks/) in your Kubernetes deployments to intervene at specific points in a release cycle.
...
For a list of all Workflow topics, see [Add Workflows](../../category/add-workflows/).
